...
public class Application implements IApplication {
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
            ...
            StringBuilder tagsLocation = new StringBuilder();
            for (int j = 0; j < tags.length ; j++) {
                tagsLocation.append("/"+tags[j]);
            }        
            
            storeQuote(quote, WORKSPACE_DIRECTORY+tagsLocation.toString()+"/quote-"+(i+1)+".utf8");
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        FileUtils.writeStringToFile(inputFile, quote.getQuote());           
    }
    ...
    public String getAuthorEmail() {
        return "karim.ghozlani@heig-vd.ch";
    }
